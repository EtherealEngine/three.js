			...
			if ( camera.isArrayCamera ) {
				...
				if ( transmissiveObjects.length > 0 ) {
					...
					for ( let i = 0, l = cameras.length; i < l; i ++ ) {
						...
						renderTransmissionPass( opaqueObjects, transmissiveObjects, scene, cameras[i] );
				...
				for ( let i = 0, l = cameras.length; i < l; i ++ ) {
					...
					renderScene( currentRenderList, scene, cameras[i], camera.cameras[ i ].viewport );
				}
			} else {
				const cameras = camera.cameras;
				...
				for ( let i = 0, l = cameras.length; i < l; i ++ ) {
					...
					if ( transmissiveObjects.length > 0 ) renderTransmissionPass( opaqueObjects, transmissiveObjects, scene, camera2 );
